      ...
      <section className="py-16 bg-brick-red text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-serif font-bold mb-6">Need Gutter Installation?</h2>
            <p className="text-xl mb-8 leading-relaxed">
              Contact us today for a free estimate on your gutter installation. Our expert team is ready to help protect your home.
            </p>
